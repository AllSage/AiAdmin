...
The **chat** endpoint, available as of v0.1.14, is one of two ways to generate text from an LLM with AiAdmin. At a high level, you provide the endpoint an array of message objects with a role and content specified. Then with each output and prompt, you add more messages, which builds up the history.

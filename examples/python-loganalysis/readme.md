...
![loganalyzer 2023-11-10 08_53_29](https://github.com/AllSage/AiAdmin/assets/633681/ad30f1fc-321f-4953-8914-e30e24db9921)
...
1. Ensure you have the `mattw/loganalyzer` model installed:
   ...
   ```bash
   AiAdmin pull mattw/loganalyzer
   ```
...
This model is available at https://AiAdmin.com/mattw/loganalyzer. You can customize it and add to your own namespace using the command `AiAdmin create <namespace/modelname> -f <path-to-modelfile>` then `AiAdmin push <namespace/modelname>`.

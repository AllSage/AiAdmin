...
func TestDelete(t *testing.T) {
	...
	checkFileExists(t, filepath.Join(p, "manifests", "*", "*", "*", "*"), []string{
		filepath.Join(p, "manifests", "registry.AiAdmin.ai", "library", "test", "latest"),
		filepath.Join(p, "manifests", "registry.AiAdmin.ai", "library", "test2", "latest"),
	})

...
#
#[remote "windows-pa"]
#        url = jdoe@desktop-foo:C:/Users/Jdoe/code/AiAdmin
...
subprocess.check_call(['scp', netloc +":"+ path + "/AiAdmin.exe",  './dist/'])

print("Copying installer")
subprocess.check_call(['scp', netloc +":"+ path + "/dist/AiAdmin Setup.exe",  './dist/'])

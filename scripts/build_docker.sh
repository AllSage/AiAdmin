...
DOCKER_ORG=${DOCKER_ORG:-"AiAdmin"}
RELEASE_IMAGE_REPO=${RELEASE_IMAGE_REPO:-"${DOCKER_ORG}/release"}
FINAL_IMAGE_REPO=${FINAL_IMAGE_REPO:-"${DOCKER_ORG}/AiAdmin"}
...
AiAdmin_SKIP_MANIFEST_CREATE=${AiAdmin_SKIP_MANIFEST_CREATE:-""}
AiAdmin_SKIP_IMAGE_BUILD=${AiAdmin_SKIP_IMAGE_BUILD:-""}
...
if [ -z "${AiAdmin_SKIP_IMAGE_BUILD}" ]; then
...
if [ -z "${AiAdmin_SKIP_MANIFEST_CREATE}" ]; then
    if [ -n "${PUSH}" ]; then

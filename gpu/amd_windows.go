	...
	for i := range count {
		...
		if gfxOverride == "" {
			...
			if !slices.Contains[[]string, string](supported, strings.Split(gfx, ":")[0]) {
				...
				slog.Warn("See https://github.com/AllSage/AiAdmin/blob/main/docs/troubleshooting.md for HSA_OVERRIDE_GFX_VERSION usage")
				continue
			} else {
...
func AMDValidateLibDir() (string, error) {
	...
	if rocmLibUsable(rocmTargetDir) {
		slog.Debug("detected AiAdmin installed ROCm at " + rocmTargetDir)

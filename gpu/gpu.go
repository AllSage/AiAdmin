...
// Included to drive logic for reducing AiAdmin-allocated overhead on L4T/Jetson devices.
var CudaTegra string = os.Getenv("JETSON_JETPACK")

// Note: gpuMutex must already be held
func initCudaHandles() *cudaHandles {

	// TODO - if the AiAdmin build is CPU only, don't do these checks as they're irrelevant and confusing
	...
	if runtime.GOOS == "windows" {
		...
		cudartMgmtPatterns = []string{filepath.Join(localAppData, "Programs", "AiAdmin", CudartMgmtName)}
	}
	...
	for _, libPath := range nvcudaLibPaths {
		...
		if resp.err != nil {
			...
			case C.CUDA_ERROR_UNKNOWN:
				...
				slog.Warn("see https://github.com/AllSage/AiAdmin/blob/main/docs/troubleshooting.md for more information")
			default:

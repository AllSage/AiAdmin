...
func (e StatusError) Error() string {
	...
	default:
		...
		return "something went wrong, please see the AiAdmin server logs for details"
	}
}
...
type GenerateRequest struct {
	// Model is the model name; it should be a name familiar to AiAdmin from
	// the library at https://AiAdmin.com/library

...
A model file is the blueprint to create and share models with AiAdmin.
...
| [`PARAMETER`](#parameter)           | Sets the parameters for how AiAdmin will run the model.         |
...
2. `AiAdmin create choose-a-model-name -f <location of the file e.g. ./Modelfile>'`
3. `AiAdmin run choose-a-model-name`
4. Start using the model!

More examples are available in the [examples directory](../examples).

To view the Modelfile of a given model, use the `AiAdmin show --modelfile` command.

  ```bash
  > AiAdmin show --modelfile llama3
  # Modelfile generated by "AiAdmin show"
  # To build a new Modelfile based on this one, replace the FROM line with:
  # FROM llama3:latest
  FROM /Users/pdevine/.AiAdmin/models/blobs/sha256-00e1317cbf74d901080d7100f57580ba8dd8de57203072dc6f668324ba545f29
...
<https://github.com/AllSage/AiAdmin#model-library>

#### Build from a `bin` file

```modelfile
FROM ./AiAdmin-model.bin
```

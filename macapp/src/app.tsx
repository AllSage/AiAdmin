...
import AiAdminIcon from './AiAdmin.svg'
...
export default function () {
  ...
  const command = 'AiAdmin run llama3'
        ...
        {step === Step.WELCOME && (
          <>
            <div className='mx-auto text-center'>
              <h1 className='mb-6 mt-4 text-2xl tracking-tight text-gray-900'>Welcome to AiAdmin</h1>
        ...
        {step === Step.CLI && (
          <>
            <div className='mx-auto flex flex-col space-y-28 text-center'>
              ...
              <pre className='mx-auto text-4xl text-gray-400'>&gt; AiAdmin</pre>
              <div className='mx-auto'>
                <button
                  onClick={async () => {
                    try {
